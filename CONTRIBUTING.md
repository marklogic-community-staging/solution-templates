...
```sh
git clone git@github.com:username/solution-templates.git solution-templates
cd solution-templates
git remote add upstream git://github.com/marklogic-community-staging/solution-templates.git
```
...
Go to https://github.com/username/data-hub-central-community and select your feature 
...
[issue tracker]: https://github.com/marklogic-community-staging/solution-templates/issues
